...
The bridge is compatible with ROKIT Locator version 2.1.
...
If you have version 2.0, checkout the corresponding tag:

    git checkout 2.1.15 -b humble-v2.0

If you have version 1.11, checkout the corresponding tag:

    git checkout 2.1.14 -b humble-v1.11

If you have version 1.10, checkout the corresponding tag:

    git checkout 2.1.13 -b humble-v1.10
