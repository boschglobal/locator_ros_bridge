...
NavigatorInterface::NavigatorInterface(const std::string & host, uint16_t port)
: session_(host, port),
  query_id_(0)
{
}
...
void NavigatorInterface::login(const std::string & user, const std::string & password)
{
...
std::unordered_map<std::string, std::pair<int32_t, int32_t>> NavigatorInterface::getAboutModules()
{
...
Poco::DynamicStruct NavigatorInterface::getConfigList()
{
...
bool NavigatorInterface::setConfigList(const Poco::DynamicStruct & config)
{
  try {
...
Poco::JSON::Object NavigatorInterface::call(
...
Poco::JSON::Object NavigatorInterface::json_rpc_call(
